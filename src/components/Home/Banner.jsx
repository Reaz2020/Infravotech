...
const Banner = () => {
  return (
    <div className="relative h-[700px] flex items-center justify-center text-black px-4">
      ...
      <div
        className="absolute inset-0 bg-cover bg-center filter  rounded-2xl"
      ...
      {/* Content */}
      <div className="relative z-10 p-10 rounded-2xl shadow-lg max-w-3xl w-full text-center text-white ">
        <h1 className="text-6xl font-extrabold mb-3 ">Welcome to NextWave</h1>
